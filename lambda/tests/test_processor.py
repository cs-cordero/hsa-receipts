...
from corderohq.archiver.processor import process_attachment
from corderohq.claude_client import EligibilityResult
...
class TestProcessAttachment:
    @patch("corderohq.archiver.processor.store_ledger")
    @patch("corderohq.archiver.processor.fetch_ledger", return_value=None)
    @patch("corderohq.archiver.processor.store_receipt", return_value="s3://b/r.pdf")
    @patch("corderohq.archiver.processor.convert_to_pdfa", return_value=b"pdf-data")
    @patch("corderohq.archiver.processor.check_hsa_eligibility")
    ...
    @patch("corderohq.archiver.processor.fetch_ledger", return_value=None)
    @patch("corderohq.archiver.processor.store_receipt", return_value="s3://b/r.pdf")
    @patch("corderohq.archiver.processor.convert_to_pdfa", return_value=b"pdf")
    @patch("corderohq.archiver.processor.check_hsa_eligibility")
    ...
    @patch("corderohq.archiver.processor.get_page_count", return_value=15)
    @patch("corderohq.archiver.processor.check_hsa_eligibility")
    ...
    @patch("corderohq.archiver.processor.store_receipt", return_value="s3://b/manual.pdf")
    @patch("corderohq.archiver.processor.convert_to_pdfa", return_value=b"pdf")
    @patch("corderohq.archiver.processor.check_hsa_eligibility")
